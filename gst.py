...
def onTouch():
    webbrowser.open_new_tab('http://www.instagram.com/piyushdubey490/')

filemenu = tk.Menu(menubar, tearoff=0)
filemenu.add_command(label="SAY THANKS TO", command = onTouch)

menubar.add_cascade(label="PD", menu=filemenu)
...
def onClick():
    ...
    if user_amount != "":
        try:
            ...
            wrong = m_box.showerror("Warning !", "Amounts are only in positive integer !")
